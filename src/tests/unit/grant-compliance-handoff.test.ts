      ...
      stageStates: {
        methodology: {
          ...
          decision: {
            status: 'fixed',
            revision: 1,
            fixedAt: '2026-04-21T00:00:00.000Z',
            sourceMessageId: 'assistant_idea_options',
            clientRequestId: 'test_request',
            selectedOption: {
              label: 'A',
              text: 'Build a cyber centre of excellence for applied public-sector readiness.',
              rationale: null,
            },
            anchor: {
            ...
            anchorHash: 'test_anchor_hash',
            constraintHash: 'test_constraint_hash',
            compilationSource: 'deterministic_fallback',
          },
          points: [
            {
              key: 'approach',
