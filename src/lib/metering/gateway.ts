...
export class LLMGateway {
  ...
  private getProviderContextLimits(modelCode: string): { maxInput: number; maxOutput: number } {
    ...
    const limits: Record<string, { maxInput: number; maxOutput: number }> = {
      ...
      'gpt-5.6': { maxInput: 400000, maxOutput: 128000 },
      'gpt-5.6-sol': { maxInput: 400000, maxOutput: 128000 },
      'gpt-5.6-terra': { maxInput: 400000, maxOutput: 128000 },
      'gpt-5.6-luna': { maxInput: 400000, maxOutput: 128000 },
      ...
      'deepseek-v4-flash-vision-exp': { maxInput: 1000000, maxOutput: 384000 },
      'deepseek-chat': { maxInput: 128000, maxOutput: 8192 },
      'deepseek-reasoner': { maxInput: 128000, maxOutput: 8192 },

      // Zhipu
      'glm-5.3': { maxInput: 1000000, maxOutput: 131072 },
      'glm-5.3-flash': { maxInput: 1000000, maxOutput: 131072 },
  ...
  private getFeatureForTask(taskCode: TaskCode): FeatureCode {
    const taskToFeatureMap: Record<TaskCode, FeatureCode> = {
      ...
      // Chat and idea analysis bill against their own features; folding them
      // into FUNDING_DISCOVERY hid both behind call-ingestion usage.
      FUNDING_CHAT: 'FUNDING_CHAT',
      IDEA_INTELLIGENCE: 'FUNDING_INTELLIGENCE',
