...
export const templateItemSchema = z.object({
  ...
  requiredFacts: z.array(z.string()).optional().default([]),
  reviewerGoal: z.string().nullable().optional(),
  forbiddenMoves: z.array(z.string()).optional().default([]),
  draftingVsSubmission: z.string().nullable().optional(),
...
export const budgetSchema = z.object({
  ...
  workflowMode: z.string().optional().default('app_draft'),
