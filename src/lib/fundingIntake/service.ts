...
async function persistDraft(
  ...
  const sharedData = {
    ...
    origin_school_id: job.origin_school_id || null,
    origin_school_name: job.origin_school_name || null,
    origin_school_source: job.origin_school_source || null,
    metadata: {
  ...
  async createJob(operator: IntakeOperator, input: IntakeSubmitInput) {
    ...
    const job = await prisma.fundingIntakeJob.create({
      data: {
        ...
        origin_school_id: input.originSchoolId || null,
        origin_school_name: input.originSchoolName || null,
        origin_school_source: input.originSchoolSource || null,
