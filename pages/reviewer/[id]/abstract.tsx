...
import AbstractReviewForm from '../../../components/AbstractReviewForm';
...
export default function AbstractReviewPage() {
  ...
  return (
    <>
      <Head>
        <title>Abstract Review | Reviewer Module</title>
      </Head>
        ...
        <header className="bg-white shadow">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <div className="flex items-center">
              ...
              <h1 className="text-2xl font-bold text-gray-800">Abstract Review</h1>
            </div>
          </div>
        </header>
